...
from models import KnowledgeGraph, MCPServer, OntologyCategory
...
class MasterDataManager:
    ...
    def get_master_data_timestamp(self) -> float | None:
    ...
    def load_master_data(self) -> tuple[list[MCPServer], list[OntologyCategory]] | None:
    ...
    def create_knowledge_graph_from_master(self) -> KnowledgeGraph | None:
    ...
    def cleanup_old_master_data(self, keep_count: int = 5):
        ...
        print("🧹 Cleaning up old master data files:")
